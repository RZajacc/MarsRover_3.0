  ...
  if (+pagesCount > 1) {
    ...
    if (+page === 1 && +pagesCount >= 3) {
      for (let i = +page; i < +page + 3; i++) {
        ...
        paginationLi.setAttribute('class', 'pagination__item')
        const paginationHref = document.createElement('a')
        if (i === +page) {
          paginationHref.setAttribute('class', 'pagination__item current-page')
        } else {
          paginationHref.setAttribute('class', 'pagination__item')
        }
    ...
    lastLi.setAttribute('class', 'pagination__item')
    const lastHref = document.createElement('a')
    lastHref.setAttribute('class', 'pagination__item')
